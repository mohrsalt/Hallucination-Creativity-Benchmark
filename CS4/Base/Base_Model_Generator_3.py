...
df=pd.read_csv("/home/users/ntu/b230051/halcre/CS4/Generations/DoLa_Ins_Llama1B_1.csv")
df2=pd.read_csv("/home/users/ntu/b230051/halcre/CS4/Generations/Base_Ins_Llama1B_1.csv")

quantization_config = BitsAndBytesConfig(load_in_8bit=True)
tokenizer = AutoTokenizer.from_pretrained("meta-llama/Llama-3.2-1B-Instruct")
model = AutoModelForCausalLM.from_pretrained("meta-llama/Llama-3.2-1B-Instruct",quantization_config=quantization_config, torch_dtype="auto",trust_remote_code=True)
...
df.to_csv("/home/users/ntu/b230051/halcre/CS4/Generations/DoLa_Ins_Llama1B_1.csv")
df2.to_csv("/home/users/ntu/b230051/halcre/CS4/Generations/Base_Ins_Llama1B_1.csv")
